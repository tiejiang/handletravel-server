...
else DWZ.loadLogin();}else if(json.statusCode==DWZ.statusCode.forbidden){
...
if($span.length==0){
$(this).css({
"background":"url(../../designer/admin/styles/dwz/themes/css/images/toolbar_icons16/"+imageName+".png) no-repeat",
...
"float":"left"});}else{
$span.css({
"background-image":"url(../../designer/admin/styles/dwz/themes/css/images/toolbar_icons16/"+imageName+".png)",
"background-position":"0 3px"});}});}(function($){
$.fn.extend({
...
var $form=$(form);
if(form[DWZ.pageInfo.numPerPage])form[DWZ.pageInfo.numPerPage].value=15;
