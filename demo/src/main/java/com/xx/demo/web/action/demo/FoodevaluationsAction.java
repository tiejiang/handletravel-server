...
public class FoodevaluationsAction extends BaseAction {
	...
	private String carteno = null;//“管理员”--根据此关键字取 行程规划
	private String guuser = null;// 用户名
	private String cartename = null;// "行程"
	

	private String carteping = null;// 行程规划
	...
	public String getFoodevaluationListCartenoByCondition() {
		...
		try {
			...
			condition.put("carteno", carteno);//通过此关键字（管理员）获取行程规划
